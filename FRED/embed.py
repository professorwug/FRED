...
__all__ = ['auto_encoder', 'flow_artist', 'GaussianVectorField', 'precomputed_distance_loss', 'directed_neighbors',
           'smoothness_of_vector_field', 'kl_divergence_loss', 'compute_grid', 'diffusion_matrix_with_grid_points']
